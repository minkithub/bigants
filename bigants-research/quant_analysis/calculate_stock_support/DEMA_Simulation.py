...
def main():
    for root, dirs, files in os.walk('/Users/minki/pythonworkspace/bigants/dataset/sample'):
        for fname in files:
            ...
            short_term = ['dema5', 'dema10', 'dema20']
            long_term = ['dema30', 'dema60', 'dema120']
            ...
            # Make DEMA data
            dema_data = Make_DEMA(data)
            concat_data = Make_DEMA(data)
            ...
            for short_val in short_term:
                for long_val in long_term:
                    ...
                    SIM_data = Start_Simulation(dema_data, money, Support, stock_count, short_val, long_val, sell_ratio, buy_ratio)
                    ...
                    # val_dema = ['date', 'close', 'start', 'high', 'low', 'volume', 'dema5', 'dema10', 'dema20', 'dema30', 'dema60', 'dema120']
