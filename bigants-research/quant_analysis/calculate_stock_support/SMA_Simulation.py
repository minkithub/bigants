...
def main():
    ...
    for root, dirs, files in os.walk('/Users/minki/pythonworkspace/bigants/dataset/sample'):
        for fname in files:
            ...
            short_term = ['sma5', 'sma10', 'sma20']
            long_term = ['sma30', 'sma60', 'sma120']
           ...
           # Set Simulation options
            ...
            # Make SMA data
            sma_data = Make_SMA(data)
            concat_data = Make_SMA(data)
            ...
            for short_val in short_term:
                for long_val in long_term:
                    ...
                    # 'TotalMoney', 'Return_Rate', 'Stock_Holdings', 'Money_WinRate', 'Transaction_WinRate', 'Transaction'])

                    SIM_data = Start_Simulation(sma_data, money, Support, stock_count, short_val, long_val, sell_ratio, buy_ratio)
